...
$serialA = Join-Path $LogDir "serial.${logTag}_stabtest.log"
$debugA  = Join-Path $LogDir "debug.${logTag}_stabtest.log"
$qemuA   = Join-Path $LogDir "qemu.${logTag}_stabtest.log"
...
# --- Boot 2: normal regression ---
Build-Iso ""
$serialB = Join-Path $LogDir "serial.${logTag}_normal.log"
$debugB  = Join-Path $LogDir "debug.${logTag}_normal.log"
$qemuB   = Join-Path $LogDir "qemu.${logTag}_normal.log"

...
#   powershell -ExecutionPolicy Bypass -File tests\test_m24d.ps1
...
Invoke-Make -Targets @("helloapp-tpkg") -Cwd $RepoRoot
...
try {
    ...
    Invoke-Make -Targets @("m24dtest") -Cwd $RepoRoot

    # 4. Run + watch serial log (same path as `make run`: logs/serial.log).

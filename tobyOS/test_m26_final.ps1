...
#
# Usage:
#   pwsh .\test_m26_final.ps1            # run all phases + summary
#   pwsh .\test_m26_final.ps1 -Skip M26B # skip a phase by tag
#   pwsh .\test_m26_final.ps1 -Build     # `make` first to ensure ISO is fresh
#
...
Write-Host "    pwsh .\test_m26a.ps1     # peripheral harness"
Write-Host "    pwsh .\test_m26b.ps1     # USB hub"
Write-Host "    pwsh .\test_m26c.ps1     # USB hot-plug"
Write-Host "    pwsh .\test_m26d.ps1     # USB HID"
Write-Host "    pwsh .\test_m26e.ps1     # USB mass storage"
Write-Host "    pwsh .\test_m26f.ps1     # HD Audio"
Write-Host "    pwsh .\test_m26g.ps1     # ACPI battery (absent + fw_cfg mock)"
Write-Host ""
Write-Host "  Or run this aggregator:"
Write-Host "    pwsh .\test_m26_final.ps1            # all phases + global sweep"
Write-Host "    pwsh .\test_m26_final.ps1 -Build     # rebuild kernel ISO first"
Write-Host "    pwsh .\test_m26_final.ps1 -Skip M26B # skip a phase by tag"
Write-Host ""

...
Remove-Item -ErrorAction SilentlyContinue `
    serial.log, debug.log, qemu.log, qemu.stderr.log
...
$res = Wait-ForPattern -path serial.log `
...
Remove-Item -ErrorAction SilentlyContinue serial.log, debug.log

...
$serialA = "serial.${logTag}_crash.log"
$debugA  = "debug.${logTag}_crash.log"
$qemuA   = "qemu.${logTag}_crash.log"
...
$serialB = "serial.${logTag}_inspect.log"
$debugB  = "debug.${logTag}_inspect.log"
$qemuB   = "qemu.${logTag}_inspect.log"

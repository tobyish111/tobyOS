#!/usr/bin/env python3
"""Slice 49 video-pipeline probe: chromewin -> local file:///opt/chrome/vidtest.html
(inline VP9 <video autoplay>). Deterministic + fast vs YouTube. WHPX. Reports
frame production, VIDEO ERROR, and any EXCEPTION; screenshots along the way."""
import json, os, socket, subprocess, time

QEMU = r"C:\Program Files\qemu\qemu-system-x86_64.exe"
ISO = "tobyOS.iso"
DISK = "disk.img"
SERIAL = "logs/run_vid.log"
PORT = 4462
SHOTS = [(55, "logs/vid_a.png"), (80, "logs/vid_b.png"),
         (110, "logs/vid_c.png"), (150, "logs/vid_d.png")]
TOTAL = 190
...
def main():
    ...
    try:
        ...
        shot_i = 0
        seen = set()
        marks = ("[TKAPP] chromewin", "[chromewin] chrome pid", "[devpipe]",
                 "[chromewin] sessionId", "bootstrap OK", "[chromewin] frame",
                 "VIDEO ERROR", "EXCEPTION 14", "exit code=-1")
        while time.time() - start < TOTAL:
            ...
            try:
                ...
                txt = ""
            for mark in marks:
                # report first + (for frames) periodic
                cnt = txt.count(mark)

#!/usr/bin/env python3
"""WHPX probe: same as run39shot.py but hardware-accelerated (-accel whpx).
If tobyOS is stable under WHPX the guest runs ~50x faster than TCG, which is
the difference between example.com and youtube.com being loadable."""
import json, os, socket, subprocess, sys, time

QEMU = r"C:\Program Files\qemu\qemu-system-x86_64.exe"
ISO = "tobyOS.iso"
DISK = "disk.img"
SERIAL = "logs/run39whpx.log"
PORT = 4460
SHOTS = [(60, "logs/shotwx_a.png"), (150, "logs/shotwx_b.png"),
         (290, "logs/shotwx_c.png")]
TOTAL = 300

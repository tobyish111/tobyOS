#!/bin/bash
# Phase 3 slice 11: build the USER-namespace acceptance test (linux-clonens.elf).
#
...
#
# Usage:   bash programs/linux-clonens/build.sh
# Output:  programs/linux-clonens/linux-clonens.elf   (gitignored; opt-in)
set -e

HERE="$(cd "$(dirname "$0")" && pwd)"
OUT="$HERE/linux-clonens.elf"

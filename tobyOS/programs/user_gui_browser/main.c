...
/* WritableStream: drives an underlying sink (start/write/close/abort). */
"  function WritableStream(sink){ this._sink = sink || {}; this._started = false; }\n"
...
"    return { write: function(chunk){ self._start();\n"
"        try { return Promise.resolve(self._sink.write ? self._sink.write(chunk) : undefined); }\n"
"        catch(e){ return Promise.reject(e); } },\n"
"      close: function(){ self._start();\n"
"        try { return Promise.resolve(self._sink.close ? self._sink.close() : undefined); }\n"
"        catch(e){ return Promise.reject(e); } },\n"
"      abort: function(reason){ try { return Promise.resolve(self._sink.abort ? self._sink.abort(reason) : undefined); }\n"
"        catch(e){ return Promise.reject(e); } },\n"
"      releaseLock: function(){}, ready: Promise.resolve(), closed: Promise.resolve() }; };\n"

#!/bin/bash
# Build the procfs deep-fidelity test (linux-proc2.elf).
#
...
#
# Usage:   bash programs/linux-proc2/build.sh
# Output:  programs/linux-proc2/linux-proc2.elf   (gitignored; opt-in)
set -e

HERE="$(cd "$(dirname "$0")" && pwd)"
OUT="$HERE/linux-proc2.elf"
...
clang --target=x86_64-unknown-linux-gnu -static -O2 -g0 -fno-stack-protector \
  ...
  -c "$HERE/main.c" -o "$HERE/linux-proc2.o"

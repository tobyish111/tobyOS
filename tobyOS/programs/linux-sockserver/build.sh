#!/bin/bash
# Build the socket-semantics test (linux-sockserver.elf).
#
...
#
# Usage:   bash programs/linux-sockserver/build.sh
# Output:  programs/linux-sockserver/linux-sockserver.elf   (gitignored; opt-in)
set -e

HERE="$(cd "$(dirname "$0")" && pwd)"
OUT="$HERE/linux-sockserver.elf"

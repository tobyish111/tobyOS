#!/bin/bash
# Build the timers + kernel-copy test (linux-io.elf).
#
...
#
# Usage:   bash programs/linux-io/build.sh
# Output:  programs/linux-io/linux-io.elf   (gitignored; opt-in)
set -e

HERE="$(cd "$(dirname "$0")" && pwd)"
OUT="$HERE/linux-io.elf"
...
clang --target=x86_64-unknown-linux-gnu -static -O2 -g0 -fno-stack-protector \
  ...
  -c "$HERE/main.c" -o "$HERE/linux-io.o"

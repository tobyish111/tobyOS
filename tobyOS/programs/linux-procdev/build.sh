#!/bin/bash
# Build the procfs+dev fidelity test (linux-procdev.elf).
#
...
#
# Usage:   bash programs/linux-procdev/build.sh
# Output:  programs/linux-procdev/linux-procdev.elf   (gitignored; opt-in)
set -e

HERE="$(cd "$(dirname "$0")" && pwd)"
OUT="$HERE/linux-procdev.elf"

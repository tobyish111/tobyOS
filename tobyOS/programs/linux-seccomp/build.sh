#!/bin/bash
# Phase 3 slice 13: build the seccomp-bpf acceptance test (linux-seccomp.elf).
#
...
#
# Usage:   bash programs/linux-seccomp/build.sh
# Output:  programs/linux-seccomp/linux-seccomp.elf   (gitignored; opt-in)
set -e

HERE="$(cd "$(dirname "$0")" && pwd)"
OUT="$HERE/linux-seccomp.elf"

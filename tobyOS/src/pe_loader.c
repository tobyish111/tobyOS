...
#define WIN32_GATE_IMM_OFF 0x37     /* offset of the syscall-number imm32 */

/* Position-independent marshalling gate. Verified by assembling the
 * equivalent .intel_syntax and extracting .text (see the commit notes).
 * On entry: rax = shim index, rcx/rdx/r8/r9 = Microsoft-x64 args 0..3.
 *
 *   push rdi ; push rsi            ; preserve MS-x64 non-volatile regs
 *   sub  rsp, 0x40                 ; 8-qword argument array
 *   mov  [rsp+00], rcx             ; arg0 ... arg3 into the array
 *   mov  [rsp+08], rdx
 *   mov  [rsp+10], r8
 *   mov  [rsp+18], r9
 *   xor  r10, r10                  ; arg4..arg7 = 0 (C1 uses <=4 reg args)
 *   mov  [rsp+20], r10 ; ... [rsp+38], r10
...
static const uint8_t g_win32_gate[] = {
    ...
    0x18, 0x4d, 0x31, 0xd2, 0x4c, 0x89, 0x54, 0x24, 0x20, 0x4c, 0x89, 0x54,
    0x24, 0x28, 0x4c, 0x89, 0x54, 0x24, 0x30, 0x4c, 0x89, 0x54, 0x24, 0x38,
    0x48, 0x89, 0xc7, 0x48, 0x89, 0xe6, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x0f,
    0x05, 0x48, 0x83, 0xc4, 0x40, 0x5e, 0x5f, 0xc3
};
